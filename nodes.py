...
class LoadImage:
    ...
    def INPUT_TYPES(s):
        return {"required":
                    {"image": ("PIL_IMAGE",)},  # Changed to accept PIL Image type
                }
    CATEGORY = "image"
    ...
    def load_image(self, image):
        # image is now a PIL.Image object instead of a file path
        img = image
    ...
    def IS_CHANGED(s, image):
        # For PIL Image objects, we can't use file-based hashing
        # Instead, we'll create a hash based on the image data
        import io
        m = hashlib.sha256()
    ...
    def VALIDATE_INPUTS(s, image):
        ...
        try:
            ...
            if not isinstance(image, Image.Image):
                return "Invalid input: expected PIL Image object"
            return True
